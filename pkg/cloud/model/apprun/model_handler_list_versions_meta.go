...
// checks if the HandlerListVersionsMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListVersionsMeta{}

// HandlerListVersionsMeta struct for HandlerListVersionsMeta
...
type _HandlerListVersionsMeta HandlerListVersionsMeta
...
func (o HandlerListVersionsMeta) MarshalJSON() ([]byte, error) {
...
func (o HandlerListVersionsMeta) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerListVersionsMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerListVersionsMeta := _HandlerListVersionsMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerListVersionsMeta)

	if err != nil {
		return err
	}

	*o = HandlerListVersionsMeta(varHandlerListVersionsMeta)

	return err
}

type NullableHandlerListVersionsMeta struct {
	value *HandlerListVersionsMeta
	isSet bool
}

func (v NullableHandlerListVersionsMeta) Get() *HandlerListVersionsMeta {
	return v.value
}

func (v *NullableHandlerListVersionsMeta) Set(val *HandlerListVersionsMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListVersionsMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListVersionsMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListVersionsMeta(val *HandlerListVersionsMeta) *NullableHandlerListVersionsMeta {
	return &NullableHandlerListVersionsMeta{value: val, isSet: true}
}

func (v NullableHandlerListVersionsMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListVersionsMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
