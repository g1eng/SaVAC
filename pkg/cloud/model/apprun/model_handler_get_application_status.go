...
// checks if the HandlerGetApplicationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerGetApplicationStatus{}

// HandlerGetApplicationStatus struct for HandlerGetApplicationStatus
type HandlerGetApplicationStatus struct {
	// アプリケーションステータス
...
type _HandlerGetApplicationStatus HandlerGetApplicationStatus
...
func NewHandlerGetApplicationStatus(status string, message string) *HandlerGetApplicationStatus {
	this := HandlerGetApplicationStatus{}
	this.Status = status
...
func (o HandlerGetApplicationStatus) MarshalJSON() ([]byte, error) {
...
func (o HandlerGetApplicationStatus) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerGetApplicationStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerGetApplicationStatus := _HandlerGetApplicationStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerGetApplicationStatus)

	if err != nil {
		return err
	}

	*o = HandlerGetApplicationStatus(varHandlerGetApplicationStatus)

	return err
}

type NullableHandlerGetApplicationStatus struct {
	value *HandlerGetApplicationStatus
	isSet bool
}

func (v NullableHandlerGetApplicationStatus) Get() *HandlerGetApplicationStatus {
	return v.value
}

func (v *NullableHandlerGetApplicationStatus) Set(val *HandlerGetApplicationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerGetApplicationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerGetApplicationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerGetApplicationStatus(val *HandlerGetApplicationStatus) *NullableHandlerGetApplicationStatus {
	return &NullableHandlerGetApplicationStatus{value: val, isSet: true}
}

func (v NullableHandlerGetApplicationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerGetApplicationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
