...
// checks if the PostApplicationBodyComponentProbeHttpGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostApplicationBodyComponentProbeHttpGet{}
...
type _PostApplicationBodyComponentProbeHttpGet PostApplicationBodyComponentProbeHttpGet
...
func NewPostApplicationBodyComponentProbeHttpGet(path string, port int32) *PostApplicationBodyComponentProbeHttpGet {
	this := PostApplicationBodyComponentProbeHttpGet{}
	this.Path = path
	this.Port = port
	return &this
}
...
func (o *PostApplicationBodyComponentProbeHttpGet) GetHeaders() []PostApplicationBodyComponentProbeHttpGetHeader {
	if o == nil || IsNil(o.Headers) {
		var ret []PostApplicationBodyComponentProbeHttpGetHeader
		return ret
	}
	return o.Headers
}
...
// SetHeaders gets a reference to the given []PostApplicationBodyComponentProbeHttpGetHeader and assigns it to the Headers field.
func (o *PostApplicationBodyComponentProbeHttpGet) SetHeaders(v []PostApplicationBodyComponentProbeHttpGetHeader) {
	o.Headers = v
}

func (o PostApplicationBodyComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
...
func (o PostApplicationBodyComponentProbeHttpGet) ToMap() (map[string]interface{}, error) {
...
func (o *PostApplicationBodyComponentProbeHttpGet) UnmarshalJSON(data []byte) (err error) {
	...
	varPostApplicationBodyComponentProbeHttpGet := _PostApplicationBodyComponentProbeHttpGet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostApplicationBodyComponentProbeHttpGet)

	if err != nil {
		return err
	}

	*o = PostApplicationBodyComponentProbeHttpGet(varPostApplicationBodyComponentProbeHttpGet)

	return err
}

type NullablePostApplicationBodyComponentProbeHttpGet struct {
	value *PostApplicationBodyComponentProbeHttpGet
	isSet bool
}

func (v NullablePostApplicationBodyComponentProbeHttpGet) Get() *PostApplicationBodyComponentProbeHttpGet {
	return v.value
}

func (v *NullablePostApplicationBodyComponentProbeHttpGet) Set(val *PostApplicationBodyComponentProbeHttpGet) {
	v.value = val
	v.isSet = true
}

func (v NullablePostApplicationBodyComponentProbeHttpGet) IsSet() bool {
	return v.isSet
}

func (v *NullablePostApplicationBodyComponentProbeHttpGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostApplicationBodyComponentProbeHttpGet(val *PostApplicationBodyComponentProbeHttpGet) *NullablePostApplicationBodyComponentProbeHttpGet {
	return &NullablePostApplicationBodyComponentProbeHttpGet{value: val, isSet: true}
}

func (v NullablePostApplicationBodyComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostApplicationBodyComponentProbeHttpGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
