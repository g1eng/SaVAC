...
// checks if the HandlerGetPacketFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerGetPacketFilter{}

// HandlerGetPacketFilter struct for HandlerGetPacketFilter
type HandlerGetPacketFilter struct {
	// 有効フラグ
	IsEnabled bool `json:"is_enabled"`
	Settings []HandlerGetPacketFilterSettingsInner `json:"settings"`
}

type _HandlerGetPacketFilter HandlerGetPacketFilter
...
func (o *HandlerGetPacketFilter) GetSettings() []HandlerGetPacketFilterSettingsInner {
	if o == nil {
		var ret []HandlerGetPacketFilterSettingsInner
		return ret
	}
...
func (o HandlerGetPacketFilter) MarshalJSON() ([]byte, error) {
...
func (o HandlerGetPacketFilter) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerGetPacketFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerGetPacketFilter := _HandlerGetPacketFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerGetPacketFilter)

	if err != nil {
		return err
	}

	*o = HandlerGetPacketFilter(varHandlerGetPacketFilter)

	return err
}

type NullableHandlerGetPacketFilter struct {
	value *HandlerGetPacketFilter
	isSet bool
}

func (v NullableHandlerGetPacketFilter) Get() *HandlerGetPacketFilter {
	return v.value
}

func (v *NullableHandlerGetPacketFilter) Set(val *HandlerGetPacketFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerGetPacketFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerGetPacketFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerGetPacketFilter(val *HandlerGetPacketFilter) *NullableHandlerGetPacketFilter {
	return &NullableHandlerGetPacketFilter{value: val, isSet: true}
}

func (v NullableHandlerGetPacketFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerGetPacketFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
