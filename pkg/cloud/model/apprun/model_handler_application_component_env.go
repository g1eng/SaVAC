...
// checks if the HandlerApplicationComponentEnv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentEnv{}

// HandlerApplicationComponentEnv struct for HandlerApplicationComponentEnv
...
func NewHandlerApplicationComponentEnv() *HandlerApplicationComponentEnv {
	this := HandlerApplicationComponentEnv{}
	return &this
}
...
func (o HandlerApplicationComponentEnv) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentEnv) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerApplicationComponentEnv struct {
	value *HandlerApplicationComponentEnv
	isSet bool
}

func (v NullableHandlerApplicationComponentEnv) Get() *HandlerApplicationComponentEnv {
	return v.value
}

func (v *NullableHandlerApplicationComponentEnv) Set(val *HandlerApplicationComponentEnv) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentEnv) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentEnv) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentEnv(val *HandlerApplicationComponentEnv) *NullableHandlerApplicationComponentEnv {
	return &NullableHandlerApplicationComponentEnv{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentEnv) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentEnv) UnmarshalJSON(src []byte) error {
	v.isSet = true
