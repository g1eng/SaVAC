...
// checks if the HandlerPutTraffics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerPutTraffics{}

// HandlerPutTraffics struct for HandlerPutTraffics
type HandlerPutTraffics struct {
	Meta map[string]interface{} `json:"meta"`
	Data []Traffic `json:"data"`
}

type _HandlerPutTraffics HandlerPutTraffics
...
func (o HandlerPutTraffics) MarshalJSON() ([]byte, error) {
...
func (o HandlerPutTraffics) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerPutTraffics) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerPutTraffics := _HandlerPutTraffics{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerPutTraffics)

	if err != nil {
		return err
	}

	*o = HandlerPutTraffics(varHandlerPutTraffics)

	return err
}

type NullableHandlerPutTraffics struct {
	value *HandlerPutTraffics
	isSet bool
}

func (v NullableHandlerPutTraffics) Get() *HandlerPutTraffics {
	return v.value
}

func (v *NullableHandlerPutTraffics) Set(val *HandlerPutTraffics) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerPutTraffics) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerPutTraffics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerPutTraffics(val *HandlerPutTraffics) *NullableHandlerPutTraffics {
	return &NullableHandlerPutTraffics{value: val, isSet: true}
}

func (v NullableHandlerPutTraffics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerPutTraffics) UnmarshalJSON(src []byte) error {
	v.isSet = true
