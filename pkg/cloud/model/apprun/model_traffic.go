...
// GetIsLatestVersion returns the IsLatestVersion field value
...
// GetIsLatestVersionOk returns a tuple with the IsLatestVersion field value
// and a boolean to check if the value has been set.
...
// SetIsLatestVersion sets field value
...
func (o Traffic) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["is_latest_version"] = o.IsLatestVersion
