...
// checks if the HandlerGetPacketFilterSettingsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerGetPacketFilterSettingsInner{}

// HandlerGetPacketFilterSettingsInner struct for HandlerGetPacketFilterSettingsInner
type HandlerGetPacketFilterSettingsInner struct {
	// 送信元IPv4アドレス
...
type _HandlerGetPacketFilterSettingsInner HandlerGetPacketFilterSettingsInner
...
func NewHandlerGetPacketFilterSettingsInner(fromIp string, fromIpPrefixLength int32) *HandlerGetPacketFilterSettingsInner {
	this := HandlerGetPacketFilterSettingsInner{}
	this.FromIp = fromIp
...
func (o HandlerGetPacketFilterSettingsInner) MarshalJSON() ([]byte, error) {
...
func (o HandlerGetPacketFilterSettingsInner) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerGetPacketFilterSettingsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerGetPacketFilterSettingsInner := _HandlerGetPacketFilterSettingsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerGetPacketFilterSettingsInner)

	if err != nil {
		return err
	}

	*o = HandlerGetPacketFilterSettingsInner(varHandlerGetPacketFilterSettingsInner)

	return err
}

type NullableHandlerGetPacketFilterSettingsInner struct {
	value *HandlerGetPacketFilterSettingsInner
	isSet bool
}

func (v NullableHandlerGetPacketFilterSettingsInner) Get() *HandlerGetPacketFilterSettingsInner {
	return v.value
}

func (v *NullableHandlerGetPacketFilterSettingsInner) Set(val *HandlerGetPacketFilterSettingsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerGetPacketFilterSettingsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerGetPacketFilterSettingsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerGetPacketFilterSettingsInner(val *HandlerGetPacketFilterSettingsInner) *NullableHandlerGetPacketFilterSettingsInner {
	return &NullableHandlerGetPacketFilterSettingsInner{value: val, isSet: true}
}

func (v NullableHandlerGetPacketFilterSettingsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerGetPacketFilterSettingsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
