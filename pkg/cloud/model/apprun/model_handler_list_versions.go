...
// checks if the HandlerListVersions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListVersions{}

// HandlerListVersions struct for HandlerListVersions
type HandlerListVersions struct {
	Meta HandlerListVersionsMeta `json:"meta"`
	Data []Version `json:"data"`
}

type _HandlerListVersions HandlerListVersions
...
func (o *HandlerListVersions) GetMeta() HandlerListVersionsMeta {
	if o == nil {
		var ret HandlerListVersionsMeta
		return ret
	}
...
func (o HandlerListVersions) MarshalJSON() ([]byte, error) {
...
func (o HandlerListVersions) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerListVersions) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerListVersions := _HandlerListVersions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerListVersions)

	if err != nil {
		return err
	}

	*o = HandlerListVersions(varHandlerListVersions)

	return err
}

type NullableHandlerListVersions struct {
	value *HandlerListVersions
	isSet bool
}

func (v NullableHandlerListVersions) Get() *HandlerListVersions {
	return v.value
}

func (v *NullableHandlerListVersions) Set(val *HandlerListVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListVersions(val *HandlerListVersions) *NullableHandlerListVersions {
	return &NullableHandlerListVersions{value: val, isSet: true}
}

func (v NullableHandlerListVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
