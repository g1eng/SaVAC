...
// checks if the PatchApplicationBodyComponentProbeHttpGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchApplicationBodyComponentProbeHttpGet{}
...
type _PatchApplicationBodyComponentProbeHttpGet PatchApplicationBodyComponentProbeHttpGet
...
func NewPatchApplicationBodyComponentProbeHttpGet(path string, port int32) *PatchApplicationBodyComponentProbeHttpGet {
	this := PatchApplicationBodyComponentProbeHttpGet{}
	this.Path = path
	this.Port = port
	return &this
}
...
func (o *PatchApplicationBodyComponentProbeHttpGet) GetHeaders() []PatchApplicationBodyComponentProbeHttpGetHeader {
	if o == nil || IsNil(o.Headers) {
		var ret []PatchApplicationBodyComponentProbeHttpGetHeader
		return ret
	}
	return o.Headers
}
...
// SetHeaders gets a reference to the given []PatchApplicationBodyComponentProbeHttpGetHeader and assigns it to the Headers field.
func (o *PatchApplicationBodyComponentProbeHttpGet) SetHeaders(v []PatchApplicationBodyComponentProbeHttpGetHeader) {
	o.Headers = v
}

func (o PatchApplicationBodyComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
...
func (o PatchApplicationBodyComponentProbeHttpGet) ToMap() (map[string]interface{}, error) {
...
func (o *PatchApplicationBodyComponentProbeHttpGet) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchApplicationBodyComponentProbeHttpGet := _PatchApplicationBodyComponentProbeHttpGet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchApplicationBodyComponentProbeHttpGet)

	if err != nil {
		return err
	}

	*o = PatchApplicationBodyComponentProbeHttpGet(varPatchApplicationBodyComponentProbeHttpGet)

	return err
}

type NullablePatchApplicationBodyComponentProbeHttpGet struct {
	value *PatchApplicationBodyComponentProbeHttpGet
	isSet bool
}

func (v NullablePatchApplicationBodyComponentProbeHttpGet) Get() *PatchApplicationBodyComponentProbeHttpGet {
	return v.value
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGet) Set(val *PatchApplicationBodyComponentProbeHttpGet) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchApplicationBodyComponentProbeHttpGet) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchApplicationBodyComponentProbeHttpGet(val *PatchApplicationBodyComponentProbeHttpGet) *NullablePatchApplicationBodyComponentProbeHttpGet {
	return &NullablePatchApplicationBodyComponentProbeHttpGet{value: val, isSet: true}
}

func (v NullablePatchApplicationBodyComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
