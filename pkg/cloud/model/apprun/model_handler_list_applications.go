...
// checks if the HandlerListApplications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListApplications{}

// HandlerListApplications struct for HandlerListApplications
type HandlerListApplications struct {
	Meta HandlerListApplicationsMeta `json:"meta"`
	Data []HandlerListApplicationsData `json:"data"`
}

type _HandlerListApplications HandlerListApplications
...
func (o *HandlerListApplications) GetMeta() HandlerListApplicationsMeta {
	if o == nil {
		var ret HandlerListApplicationsMeta
		return ret
	}
...
func (o *HandlerListApplications) GetData() []HandlerListApplicationsData {
	if o == nil {
		var ret []HandlerListApplicationsData
		return ret
	}
...
func (o HandlerListApplications) MarshalJSON() ([]byte, error) {
...
func (o HandlerListApplications) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerListApplications) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerListApplications := _HandlerListApplications{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerListApplications)

	if err != nil {
		return err
	}

	*o = HandlerListApplications(varHandlerListApplications)

	return err
}

type NullableHandlerListApplications struct {
	value *HandlerListApplications
	isSet bool
}

func (v NullableHandlerListApplications) Get() *HandlerListApplications {
	return v.value
}

func (v *NullableHandlerListApplications) Set(val *HandlerListApplications) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListApplications) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListApplications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListApplications(val *HandlerListApplications) *NullableHandlerListApplications {
	return &NullableHandlerListApplications{value: val, isSet: true}
}

func (v NullableHandlerListApplications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListApplications) UnmarshalJSON(src []byte) error {
	v.isSet = true
