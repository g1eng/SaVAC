...
// checks if the ModelDefaultErrorError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelDefaultErrorError{}

// ModelDefaultErrorError struct for ModelDefaultErrorError
...
type _ModelDefaultErrorError ModelDefaultErrorError
...
func (o ModelDefaultErrorError) MarshalJSON() ([]byte, error) {
...
func (o ModelDefaultErrorError) ToMap() (map[string]interface{}, error) {
...
func (o *ModelDefaultErrorError) UnmarshalJSON(data []byte) (err error) {
	...
	varModelDefaultErrorError := _ModelDefaultErrorError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModelDefaultErrorError)

	if err != nil {
		return err
	}

	*o = ModelDefaultErrorError(varModelDefaultErrorError)

	return err
}

type NullableModelDefaultErrorError struct {
	value *ModelDefaultErrorError
	isSet bool
}

func (v NullableModelDefaultErrorError) Get() *ModelDefaultErrorError {
	return v.value
}

func (v *NullableModelDefaultErrorError) Set(val *ModelDefaultErrorError) {
	v.value = val
	v.isSet = true
}

func (v NullableModelDefaultErrorError) IsSet() bool {
	return v.isSet
}

func (v *NullableModelDefaultErrorError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelDefaultErrorError(val *ModelDefaultErrorError) *NullableModelDefaultErrorError {
	return &NullableModelDefaultErrorError{value: val, isSet: true}
}

func (v NullableModelDefaultErrorError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelDefaultErrorError) UnmarshalJSON(src []byte) error {
	v.isSet = true
