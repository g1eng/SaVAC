...
// checks if the PostApplicationBodyComponentProbeHttpGetHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostApplicationBodyComponentProbeHttpGetHeader{}

// PostApplicationBodyComponentProbeHttpGetHeader struct for PostApplicationBodyComponentProbeHttpGetHeader
...
func NewPostApplicationBodyComponentProbeHttpGetHeader() *PostApplicationBodyComponentProbeHttpGetHeader {
	this := PostApplicationBodyComponentProbeHttpGetHeader{}
	return &this
}
...
func (o PostApplicationBodyComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
...
func (o PostApplicationBodyComponentProbeHttpGetHeader) ToMap() (map[string]interface{}, error) {
...
type NullablePostApplicationBodyComponentProbeHttpGetHeader struct {
	value *PostApplicationBodyComponentProbeHttpGetHeader
	isSet bool
}

func (v NullablePostApplicationBodyComponentProbeHttpGetHeader) Get() *PostApplicationBodyComponentProbeHttpGetHeader {
	return v.value
}

func (v *NullablePostApplicationBodyComponentProbeHttpGetHeader) Set(val *PostApplicationBodyComponentProbeHttpGetHeader) {
	v.value = val
	v.isSet = true
}

func (v NullablePostApplicationBodyComponentProbeHttpGetHeader) IsSet() bool {
	return v.isSet
}

func (v *NullablePostApplicationBodyComponentProbeHttpGetHeader) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostApplicationBodyComponentProbeHttpGetHeader(val *PostApplicationBodyComponentProbeHttpGetHeader) *NullablePostApplicationBodyComponentProbeHttpGetHeader {
	return &NullablePostApplicationBodyComponentProbeHttpGetHeader{value: val, isSet: true}
}

func (v NullablePostApplicationBodyComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostApplicationBodyComponentProbeHttpGetHeader) UnmarshalJSON(src []byte) error {
	v.isSet = true
