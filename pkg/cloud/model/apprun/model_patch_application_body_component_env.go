...
// checks if the PatchApplicationBodyComponentEnv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchApplicationBodyComponentEnv{}

// PatchApplicationBodyComponentEnv struct for PatchApplicationBodyComponentEnv
...
func NewPatchApplicationBodyComponentEnv() *PatchApplicationBodyComponentEnv {
	this := PatchApplicationBodyComponentEnv{}
	return &this
}
...
func (o PatchApplicationBodyComponentEnv) MarshalJSON() ([]byte, error) {
...
func (o PatchApplicationBodyComponentEnv) ToMap() (map[string]interface{}, error) {
...
type NullablePatchApplicationBodyComponentEnv struct {
	value *PatchApplicationBodyComponentEnv
	isSet bool
}

func (v NullablePatchApplicationBodyComponentEnv) Get() *PatchApplicationBodyComponentEnv {
	return v.value
}

func (v *NullablePatchApplicationBodyComponentEnv) Set(val *PatchApplicationBodyComponentEnv) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchApplicationBodyComponentEnv) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchApplicationBodyComponentEnv) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchApplicationBodyComponentEnv(val *PatchApplicationBodyComponentEnv) *NullablePatchApplicationBodyComponentEnv {
	return &NullablePatchApplicationBodyComponentEnv{value: val, isSet: true}
}

func (v NullablePatchApplicationBodyComponentEnv) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchApplicationBodyComponentEnv) UnmarshalJSON(src []byte) error {
	v.isSet = true
