...
// checks if the PatchApplicationBodyComponentDeploySourceContainerRegistry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchApplicationBodyComponentDeploySourceContainerRegistry{}
...
type _PatchApplicationBodyComponentDeploySourceContainerRegistry PatchApplicationBodyComponentDeploySourceContainerRegistry
...
func NewPatchApplicationBodyComponentDeploySourceContainerRegistry(image string) *PatchApplicationBodyComponentDeploySourceContainerRegistry {
	this := PatchApplicationBodyComponentDeploySourceContainerRegistry{}
	this.Image = image
	return &this
}
...
func (o *PatchApplicationBodyComponentDeploySourceContainerRegistry) SetServerNil() {
	o.Server.Set(nil)
}
...
func (o *PatchApplicationBodyComponentDeploySourceContainerRegistry) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *PatchApplicationBodyComponentDeploySourceContainerRegistry) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o PatchApplicationBodyComponentDeploySourceContainerRegistry) MarshalJSON() ([]byte, error) {
...
func (o PatchApplicationBodyComponentDeploySourceContainerRegistry) ToMap() (map[string]interface{}, error) {
...
func (o *PatchApplicationBodyComponentDeploySourceContainerRegistry) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchApplicationBodyComponentDeploySourceContainerRegistry := _PatchApplicationBodyComponentDeploySourceContainerRegistry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchApplicationBodyComponentDeploySourceContainerRegistry)

	if err != nil {
		return err
	}

	*o = PatchApplicationBodyComponentDeploySourceContainerRegistry(varPatchApplicationBodyComponentDeploySourceContainerRegistry)

	return err
}

type NullablePatchApplicationBodyComponentDeploySourceContainerRegistry struct {
	value *PatchApplicationBodyComponentDeploySourceContainerRegistry
	isSet bool
}

func (v NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) Get() *PatchApplicationBodyComponentDeploySourceContainerRegistry {
	return v.value
}

func (v *NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) Set(val *PatchApplicationBodyComponentDeploySourceContainerRegistry) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchApplicationBodyComponentDeploySourceContainerRegistry(val *PatchApplicationBodyComponentDeploySourceContainerRegistry) *NullablePatchApplicationBodyComponentDeploySourceContainerRegistry {
	return &NullablePatchApplicationBodyComponentDeploySourceContainerRegistry{value: val, isSet: true}
}

func (v NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchApplicationBodyComponentDeploySourceContainerRegistry) UnmarshalJSON(src []byte) error {
	v.isSet = true
