...
// checks if the PatchApplicationBodyComponentProbe type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchApplicationBodyComponentProbe{}

// PatchApplicationBodyComponentProbe コンポーネントのプローブ設定
type PatchApplicationBodyComponentProbe struct {
	HttpGet NullablePatchApplicationBodyComponentProbeHttpGet `json:"http_get,omitempty"`
}
...
func NewPatchApplicationBodyComponentProbe() *PatchApplicationBodyComponentProbe {
	this := PatchApplicationBodyComponentProbe{}
	return &this
}
...
func (o *PatchApplicationBodyComponentProbe) GetHttpGet() PatchApplicationBodyComponentProbeHttpGet {
	if o == nil || IsNil(o.HttpGet.Get()) {
		var ret PatchApplicationBodyComponentProbeHttpGet
		return ret
	}
...
// SetHttpGet gets a reference to the given NullablePatchApplicationBodyComponentProbeHttpGet and assigns it to the HttpGet field.
...
func (o *PatchApplicationBodyComponentProbe) SetHttpGetNil() {
	o.HttpGet.Set(nil)
}
...
func (o PatchApplicationBodyComponentProbe) MarshalJSON() ([]byte, error) {
...
func (o PatchApplicationBodyComponentProbe) ToMap() (map[string]interface{}, error) {
...
type NullablePatchApplicationBodyComponentProbe struct {
	value *PatchApplicationBodyComponentProbe
	isSet bool
}

func (v NullablePatchApplicationBodyComponentProbe) Get() *PatchApplicationBodyComponentProbe {
	return v.value
}

func (v *NullablePatchApplicationBodyComponentProbe) Set(val *PatchApplicationBodyComponentProbe) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchApplicationBodyComponentProbe) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchApplicationBodyComponentProbe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchApplicationBodyComponentProbe(val *PatchApplicationBodyComponentProbe) *NullablePatchApplicationBodyComponentProbe {
	return &NullablePatchApplicationBodyComponentProbe{value: val, isSet: true}
}

func (v NullablePatchApplicationBodyComponentProbe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchApplicationBodyComponentProbe) UnmarshalJSON(src []byte) error {
	v.isSet = true
