...
// checks if the HandlerPatchPacketFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerPatchPacketFilter{}

// HandlerPatchPacketFilter struct for HandlerPatchPacketFilter
type HandlerPatchPacketFilter struct {
	// 有効フラグ
	IsEnabled bool `json:"is_enabled"`
	Settings []HandlerPatchPacketFilterSettingsInner `json:"settings"`
}

type _HandlerPatchPacketFilter HandlerPatchPacketFilter
...
func (o HandlerPatchPacketFilter) MarshalJSON() ([]byte, error) {
...
func (o HandlerPatchPacketFilter) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerPatchPacketFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerPatchPacketFilter := _HandlerPatchPacketFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerPatchPacketFilter)

	if err != nil {
		return err
	}

	*o = HandlerPatchPacketFilter(varHandlerPatchPacketFilter)

	return err
}

type NullableHandlerPatchPacketFilter struct {
	value *HandlerPatchPacketFilter
	isSet bool
}

func (v NullableHandlerPatchPacketFilter) Get() *HandlerPatchPacketFilter {
	return v.value
}

func (v *NullableHandlerPatchPacketFilter) Set(val *HandlerPatchPacketFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerPatchPacketFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerPatchPacketFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerPatchPacketFilter(val *HandlerPatchPacketFilter) *NullableHandlerPatchPacketFilter {
	return &NullableHandlerPatchPacketFilter{value: val, isSet: true}
}

func (v NullableHandlerPatchPacketFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerPatchPacketFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
