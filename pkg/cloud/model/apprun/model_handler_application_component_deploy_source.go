...
// checks if the HandlerApplicationComponentDeploySource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentDeploySource{}
...
func NewHandlerApplicationComponentDeploySource() *HandlerApplicationComponentDeploySource {
	this := HandlerApplicationComponentDeploySource{}
	return &this
}
...
func (o *HandlerApplicationComponentDeploySource) GetContainerRegistry() HandlerApplicationComponentDeploySourceContainerRegistry {
	if o == nil || IsNil(o.ContainerRegistry) {
		var ret HandlerApplicationComponentDeploySourceContainerRegistry
		return ret
	}
...
// SetContainerRegistry gets a reference to the given HandlerApplicationComponentDeploySourceContainerRegistry and assigns it to the ContainerRegistry field.
...
func (o HandlerApplicationComponentDeploySource) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentDeploySource) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerApplicationComponentDeploySource struct {
	value *HandlerApplicationComponentDeploySource
	isSet bool
}

func (v NullableHandlerApplicationComponentDeploySource) Get() *HandlerApplicationComponentDeploySource {
	return v.value
}

func (v *NullableHandlerApplicationComponentDeploySource) Set(val *HandlerApplicationComponentDeploySource) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentDeploySource) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentDeploySource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentDeploySource(val *HandlerApplicationComponentDeploySource) *NullableHandlerApplicationComponentDeploySource {
	return &NullableHandlerApplicationComponentDeploySource{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentDeploySource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentDeploySource) UnmarshalJSON(src []byte) error {
	v.isSet = true
