...
// checks if the HandlerApplicationComponentProbeHttpGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentProbeHttpGet{}
...
type _HandlerApplicationComponentProbeHttpGet HandlerApplicationComponentProbeHttpGet
...
func NewHandlerApplicationComponentProbeHttpGet(path string, port int32) *HandlerApplicationComponentProbeHttpGet {
	this := HandlerApplicationComponentProbeHttpGet{}
	this.Path = path
	this.Port = port
	return &this
}
...
func (o *HandlerApplicationComponentProbeHttpGet) GetHeaders() []HandlerApplicationComponentProbeHttpGetHeader {
	if o == nil || IsNil(o.Headers) {
		var ret []HandlerApplicationComponentProbeHttpGetHeader
		return ret
	}
	return o.Headers
}
...
// SetHeaders gets a reference to the given []HandlerApplicationComponentProbeHttpGetHeader and assigns it to the Headers field.
func (o *HandlerApplicationComponentProbeHttpGet) SetHeaders(v []HandlerApplicationComponentProbeHttpGetHeader) {
	o.Headers = v
}

func (o HandlerApplicationComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentProbeHttpGet) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerApplicationComponentProbeHttpGet) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerApplicationComponentProbeHttpGet := _HandlerApplicationComponentProbeHttpGet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerApplicationComponentProbeHttpGet)

	if err != nil {
		return err
	}

	*o = HandlerApplicationComponentProbeHttpGet(varHandlerApplicationComponentProbeHttpGet)

	return err
}

type NullableHandlerApplicationComponentProbeHttpGet struct {
	value *HandlerApplicationComponentProbeHttpGet
	isSet bool
}

func (v NullableHandlerApplicationComponentProbeHttpGet) Get() *HandlerApplicationComponentProbeHttpGet {
	return v.value
}

func (v *NullableHandlerApplicationComponentProbeHttpGet) Set(val *HandlerApplicationComponentProbeHttpGet) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentProbeHttpGet) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentProbeHttpGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentProbeHttpGet(val *HandlerApplicationComponentProbeHttpGet) *NullableHandlerApplicationComponentProbeHttpGet {
	return &NullableHandlerApplicationComponentProbeHttpGet{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentProbeHttpGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentProbeHttpGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
