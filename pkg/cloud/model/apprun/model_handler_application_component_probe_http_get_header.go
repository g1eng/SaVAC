...
// checks if the HandlerApplicationComponentProbeHttpGetHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentProbeHttpGetHeader{}

// HandlerApplicationComponentProbeHttpGetHeader struct for HandlerApplicationComponentProbeHttpGetHeader
...
func NewHandlerApplicationComponentProbeHttpGetHeader() *HandlerApplicationComponentProbeHttpGetHeader {
	this := HandlerApplicationComponentProbeHttpGetHeader{}
	return &this
}
...
func (o HandlerApplicationComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentProbeHttpGetHeader) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerApplicationComponentProbeHttpGetHeader struct {
	value *HandlerApplicationComponentProbeHttpGetHeader
	isSet bool
}

func (v NullableHandlerApplicationComponentProbeHttpGetHeader) Get() *HandlerApplicationComponentProbeHttpGetHeader {
	return v.value
}

func (v *NullableHandlerApplicationComponentProbeHttpGetHeader) Set(val *HandlerApplicationComponentProbeHttpGetHeader) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentProbeHttpGetHeader) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentProbeHttpGetHeader) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentProbeHttpGetHeader(val *HandlerApplicationComponentProbeHttpGetHeader) *NullableHandlerApplicationComponentProbeHttpGetHeader {
	return &NullableHandlerApplicationComponentProbeHttpGetHeader{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentProbeHttpGetHeader) UnmarshalJSON(src []byte) error {
	v.isSet = true
