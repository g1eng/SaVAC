...
// checks if the HandlerListTraffics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListTraffics{}

// HandlerListTraffics struct for HandlerListTraffics
type HandlerListTraffics struct {
	Meta map[string]interface{} `json:"meta,omitempty"`
	Data []Traffic `json:"data"`
}

type _HandlerListTraffics HandlerListTraffics
...
func (o HandlerListTraffics) MarshalJSON() ([]byte, error) {
...
func (o HandlerListTraffics) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerListTraffics) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerListTraffics := _HandlerListTraffics{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerListTraffics)

	if err != nil {
		return err
	}

	*o = HandlerListTraffics(varHandlerListTraffics)

	return err
}

type NullableHandlerListTraffics struct {
	value *HandlerListTraffics
	isSet bool
}

func (v NullableHandlerListTraffics) Get() *HandlerListTraffics {
	return v.value
}

func (v *NullableHandlerListTraffics) Set(val *HandlerListTraffics) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListTraffics) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListTraffics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListTraffics(val *HandlerListTraffics) *NullableHandlerListTraffics {
	return &NullableHandlerListTraffics{value: val, isSet: true}
}

func (v NullableHandlerListTraffics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListTraffics) UnmarshalJSON(src []byte) error {
	v.isSet = true
