...
// checks if the HandlerListApplicationsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListApplicationsData{}

// HandlerListApplicationsData struct for HandlerListApplicationsData
...
type _HandlerListApplicationsData HandlerListApplicationsData
...
func NewHandlerListApplicationsData(id string, name string, status string, publicUrl string, createdAt time.Time) *HandlerListApplicationsData {
	this := HandlerListApplicationsData{}
	this.Id = id
	this.Name = name
	this.Status = status
...
func (o HandlerListApplicationsData) MarshalJSON() ([]byte, error) {
...
func (o HandlerListApplicationsData) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerListApplicationsData) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerListApplicationsData := _HandlerListApplicationsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerListApplicationsData)

	if err != nil {
		return err
	}

	*o = HandlerListApplicationsData(varHandlerListApplicationsData)

	return err
}

type NullableHandlerListApplicationsData struct {
	value *HandlerListApplicationsData
	isSet bool
}

func (v NullableHandlerListApplicationsData) Get() *HandlerListApplicationsData {
	return v.value
}

func (v *NullableHandlerListApplicationsData) Set(val *HandlerListApplicationsData) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListApplicationsData) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListApplicationsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListApplicationsData(val *HandlerListApplicationsData) *NullableHandlerListApplicationsData {
	return &NullableHandlerListApplicationsData{value: val, isSet: true}
}

func (v NullableHandlerListApplicationsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListApplicationsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
