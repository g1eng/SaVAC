...
// checks if the HandlerApplicationComponent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponent{}

// HandlerApplicationComponent struct for HandlerApplicationComponent
type HandlerApplicationComponent struct {
	...
	Probe NullableHandlerApplicationComponentProbe `json:"probe,omitempty"`
}

type _HandlerApplicationComponent HandlerApplicationComponent
...
func NewHandlerApplicationComponent(name string, maxCpu string, maxMemory string, deploySource HandlerApplicationComponentDeploySource) *HandlerApplicationComponent {
	this := HandlerApplicationComponent{}
	this.Name = name
	this.MaxCpu = maxCpu
...
func (o *HandlerApplicationComponent) GetDeploySource() HandlerApplicationComponentDeploySource {
	if o == nil {
		var ret HandlerApplicationComponentDeploySource
		return ret
	}
...
func (o *HandlerApplicationComponent) GetEnv() []HandlerApplicationComponentEnv {
	if o == nil || IsNil(o.Env) {
		var ret []HandlerApplicationComponentEnv
		return ret
	}
	return o.Env
}
...
// SetEnv gets a reference to the given []HandlerApplicationComponentEnv and assigns it to the Env field.
...
func (o *HandlerApplicationComponent) GetProbe() HandlerApplicationComponentProbe {
	if o == nil || IsNil(o.Probe.Get()) {
		var ret HandlerApplicationComponentProbe
		return ret
	}
	return *o.Probe.Get()
}
...
// SetProbe gets a reference to the given NullableHandlerApplicationComponentProbe and assigns it to the Probe field.
...
func (o *HandlerApplicationComponent) SetProbeNil() {
	o.Probe.Set(nil)
}
...
func (o HandlerApplicationComponent) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponent) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerApplicationComponent) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerApplicationComponent := _HandlerApplicationComponent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerApplicationComponent)

	if err != nil {
		return err
	}

	*o = HandlerApplicationComponent(varHandlerApplicationComponent)

	return err
}

type NullableHandlerApplicationComponent struct {
	value *HandlerApplicationComponent
	isSet bool
}

func (v NullableHandlerApplicationComponent) Get() *HandlerApplicationComponent {
	return v.value
}

func (v *NullableHandlerApplicationComponent) Set(val *HandlerApplicationComponent) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponent) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponent(val *HandlerApplicationComponent) *NullableHandlerApplicationComponent {
	return &NullableHandlerApplicationComponent{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponent) UnmarshalJSON(src []byte) error {
	v.isSet = true
