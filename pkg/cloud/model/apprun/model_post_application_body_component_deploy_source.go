...
// checks if the PostApplicationBodyComponentDeploySource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostApplicationBodyComponentDeploySource{}
...
func NewPostApplicationBodyComponentDeploySource() *PostApplicationBodyComponentDeploySource {
	this := PostApplicationBodyComponentDeploySource{}
	return &this
}
...
func (o *PostApplicationBodyComponentDeploySource) GetContainerRegistry() PostApplicationBodyComponentDeploySourceContainerRegistry {
	if o == nil || IsNil(o.ContainerRegistry) {
		var ret PostApplicationBodyComponentDeploySourceContainerRegistry
		return ret
	}
...
// SetContainerRegistry gets a reference to the given PostApplicationBodyComponentDeploySourceContainerRegistry and assigns it to the ContainerRegistry field.
...
func (o PostApplicationBodyComponentDeploySource) MarshalJSON() ([]byte, error) {
...
func (o PostApplicationBodyComponentDeploySource) ToMap() (map[string]interface{}, error) {
...
type NullablePostApplicationBodyComponentDeploySource struct {
	value *PostApplicationBodyComponentDeploySource
	isSet bool
}

func (v NullablePostApplicationBodyComponentDeploySource) Get() *PostApplicationBodyComponentDeploySource {
	return v.value
}

func (v *NullablePostApplicationBodyComponentDeploySource) Set(val *PostApplicationBodyComponentDeploySource) {
	v.value = val
	v.isSet = true
}

func (v NullablePostApplicationBodyComponentDeploySource) IsSet() bool {
	return v.isSet
}

func (v *NullablePostApplicationBodyComponentDeploySource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostApplicationBodyComponentDeploySource(val *PostApplicationBodyComponentDeploySource) *NullablePostApplicationBodyComponentDeploySource {
	return &NullablePostApplicationBodyComponentDeploySource{value: val, isSet: true}
}

func (v NullablePostApplicationBodyComponentDeploySource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostApplicationBodyComponentDeploySource) UnmarshalJSON(src []byte) error {
	v.isSet = true
