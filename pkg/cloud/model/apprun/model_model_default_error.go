...
// checks if the ModelDefaultError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelDefaultError{}

// ModelDefaultError struct for ModelDefaultError
type ModelDefaultError struct {
	Error ModelDefaultErrorError `json:"error"`
}

type _ModelDefaultError ModelDefaultError
...
func (o *ModelDefaultError) GetError() ModelDefaultErrorError {
	if o == nil {
		var ret ModelDefaultErrorError
		return ret
	}
...
func (o ModelDefaultError) MarshalJSON() ([]byte, error) {
...
func (o ModelDefaultError) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["error"] = o.Error
	return toSerialize, nil
}

func (o *ModelDefaultError) UnmarshalJSON(data []byte) (err error) {
	...
	varModelDefaultError := _ModelDefaultError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModelDefaultError)

	if err != nil {
		return err
	}

	*o = ModelDefaultError(varModelDefaultError)

	return err
}

type NullableModelDefaultError struct {
	value *ModelDefaultError
	isSet bool
}

func (v NullableModelDefaultError) Get() *ModelDefaultError {
	return v.value
}

func (v *NullableModelDefaultError) Set(val *ModelDefaultError) {
	v.value = val
	v.isSet = true
}

func (v NullableModelDefaultError) IsSet() bool {
	return v.isSet
}

func (v *NullableModelDefaultError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelDefaultError(val *ModelDefaultError) *NullableModelDefaultError {
	return &NullableModelDefaultError{value: val, isSet: true}
}

func (v NullableModelDefaultError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelDefaultError) UnmarshalJSON(src []byte) error {
	v.isSet = true
