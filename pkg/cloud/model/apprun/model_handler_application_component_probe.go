...
// checks if the HandlerApplicationComponentProbe type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentProbe{}

// HandlerApplicationComponentProbe コンポーネントのプローブ設定
type HandlerApplicationComponentProbe struct {
	HttpGet NullableHandlerApplicationComponentProbeHttpGet `json:"http_get,omitempty"`
}
...
func NewHandlerApplicationComponentProbe() *HandlerApplicationComponentProbe {
	this := HandlerApplicationComponentProbe{}
	return &this
}
...
func (o *HandlerApplicationComponentProbe) GetHttpGet() HandlerApplicationComponentProbeHttpGet {
	if o == nil || IsNil(o.HttpGet.Get()) {
		var ret HandlerApplicationComponentProbeHttpGet
		return ret
	}
...
// SetHttpGet gets a reference to the given NullableHandlerApplicationComponentProbeHttpGet and assigns it to the HttpGet field.
...
func (o *HandlerApplicationComponentProbe) SetHttpGetNil() {
	o.HttpGet.Set(nil)
}
...
func (o HandlerApplicationComponentProbe) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentProbe) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerApplicationComponentProbe struct {
	value *HandlerApplicationComponentProbe
	isSet bool
}

func (v NullableHandlerApplicationComponentProbe) Get() *HandlerApplicationComponentProbe {
	return v.value
}

func (v *NullableHandlerApplicationComponentProbe) Set(val *HandlerApplicationComponentProbe) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentProbe) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentProbe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentProbe(val *HandlerApplicationComponentProbe) *NullableHandlerApplicationComponentProbe {
	return &NullableHandlerApplicationComponentProbe{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentProbe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentProbe) UnmarshalJSON(src []byte) error {
	v.isSet = true
