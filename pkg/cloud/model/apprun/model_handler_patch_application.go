...
// checks if the HandlerPatchApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerPatchApplication{}

// HandlerPatchApplication struct for HandlerPatchApplication
...
type _HandlerPatchApplication HandlerPatchApplication
...
func (o HandlerPatchApplication) MarshalJSON() ([]byte, error) {
...
func (o HandlerPatchApplication) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerPatchApplication) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerPatchApplication := _HandlerPatchApplication{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerPatchApplication)

	if err != nil {
		return err
	}

	*o = HandlerPatchApplication(varHandlerPatchApplication)

	return err
}

type NullableHandlerPatchApplication struct {
	value *HandlerPatchApplication
	isSet bool
}

func (v NullableHandlerPatchApplication) Get() *HandlerPatchApplication {
	return v.value
}

func (v *NullableHandlerPatchApplication) Set(val *HandlerPatchApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerPatchApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerPatchApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerPatchApplication(val *HandlerPatchApplication) *NullableHandlerPatchApplication {
	return &NullableHandlerPatchApplication{value: val, isSet: true}
}

func (v NullableHandlerPatchApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerPatchApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
