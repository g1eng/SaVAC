...
// checks if the PatchApplicationBodyComponentProbeHttpGetHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchApplicationBodyComponentProbeHttpGetHeader{}

// PatchApplicationBodyComponentProbeHttpGetHeader struct for PatchApplicationBodyComponentProbeHttpGetHeader
...
func NewPatchApplicationBodyComponentProbeHttpGetHeader() *PatchApplicationBodyComponentProbeHttpGetHeader {
	this := PatchApplicationBodyComponentProbeHttpGetHeader{}
	return &this
}
...
func (o PatchApplicationBodyComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
...
func (o PatchApplicationBodyComponentProbeHttpGetHeader) ToMap() (map[string]interface{}, error) {
...
type NullablePatchApplicationBodyComponentProbeHttpGetHeader struct {
	value *PatchApplicationBodyComponentProbeHttpGetHeader
	isSet bool
}

func (v NullablePatchApplicationBodyComponentProbeHttpGetHeader) Get() *PatchApplicationBodyComponentProbeHttpGetHeader {
	return v.value
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGetHeader) Set(val *PatchApplicationBodyComponentProbeHttpGetHeader) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchApplicationBodyComponentProbeHttpGetHeader) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGetHeader) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchApplicationBodyComponentProbeHttpGetHeader(val *PatchApplicationBodyComponentProbeHttpGetHeader) *NullablePatchApplicationBodyComponentProbeHttpGetHeader {
	return &NullablePatchApplicationBodyComponentProbeHttpGetHeader{value: val, isSet: true}
}

func (v NullablePatchApplicationBodyComponentProbeHttpGetHeader) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchApplicationBodyComponentProbeHttpGetHeader) UnmarshalJSON(src []byte) error {
	v.isSet = true
