...
// checks if the HandlerApplicationComponentDeploySourceContainerRegistry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerApplicationComponentDeploySourceContainerRegistry{}
...
type _HandlerApplicationComponentDeploySourceContainerRegistry HandlerApplicationComponentDeploySourceContainerRegistry
...
func NewHandlerApplicationComponentDeploySourceContainerRegistry(image string) *HandlerApplicationComponentDeploySourceContainerRegistry {
	this := HandlerApplicationComponentDeploySourceContainerRegistry{}
	this.Image = image
	return &this
}
...
func (o HandlerApplicationComponentDeploySourceContainerRegistry) MarshalJSON() ([]byte, error) {
...
func (o HandlerApplicationComponentDeploySourceContainerRegistry) ToMap() (map[string]interface{}, error) {
...
func (o *HandlerApplicationComponentDeploySourceContainerRegistry) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerApplicationComponentDeploySourceContainerRegistry := _HandlerApplicationComponentDeploySourceContainerRegistry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerApplicationComponentDeploySourceContainerRegistry)

	if err != nil {
		return err
	}

	*o = HandlerApplicationComponentDeploySourceContainerRegistry(varHandlerApplicationComponentDeploySourceContainerRegistry)

	return err
}

type NullableHandlerApplicationComponentDeploySourceContainerRegistry struct {
	value *HandlerApplicationComponentDeploySourceContainerRegistry
	isSet bool
}

func (v NullableHandlerApplicationComponentDeploySourceContainerRegistry) Get() *HandlerApplicationComponentDeploySourceContainerRegistry {
	return v.value
}

func (v *NullableHandlerApplicationComponentDeploySourceContainerRegistry) Set(val *HandlerApplicationComponentDeploySourceContainerRegistry) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerApplicationComponentDeploySourceContainerRegistry) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerApplicationComponentDeploySourceContainerRegistry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerApplicationComponentDeploySourceContainerRegistry(val *HandlerApplicationComponentDeploySourceContainerRegistry) *NullableHandlerApplicationComponentDeploySourceContainerRegistry {
	return &NullableHandlerApplicationComponentDeploySourceContainerRegistry{value: val, isSet: true}
}

func (v NullableHandlerApplicationComponentDeploySourceContainerRegistry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerApplicationComponentDeploySourceContainerRegistry) UnmarshalJSON(src []byte) error {
	v.isSet = true
