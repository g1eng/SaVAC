...
// checks if the PermissionBucketControlsBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionBucketControlsBody{}

// PermissionBucketControlsBody Request body for bucket controls for Permission
...
// NewPermissionBucketControlsBody instantiates a new PermissionBucketControlsBody object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionBucketControlsBody() *PermissionBucketControlsBody {
	this := PermissionBucketControlsBody{}
	return &this
}

// NewPermissionBucketControlsBodyWithDefaults instantiates a new PermissionBucketControlsBody object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionBucketControlsBodyWithDefaults() *PermissionBucketControlsBody {
	this := PermissionBucketControlsBody{}
	return &this
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *PermissionBucketControlsBody) GetDisplayName() string {
...
func (o *PermissionBucketControlsBody) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *PermissionBucketControlsBody) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *PermissionBucketControlsBody) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetBucketControls returns the BucketControls field value if set, zero value otherwise.
func (o *PermissionBucketControlsBody) GetBucketControls() []BucketControlsInner {
...
// and a boolean to check if the value has been set.
func (o *PermissionBucketControlsBody) GetBucketControlsOk() ([]BucketControlsInner, bool) {
	if o == nil || IsNil(o.BucketControls) {
		return nil, false
	}
...
func (o *PermissionBucketControlsBody) HasBucketControls() bool {
	if o != nil && !IsNil(o.BucketControls) {
		return true
	}
...
func (o *PermissionBucketControlsBody) SetBucketControls(v []BucketControlsInner) {
	o.BucketControls = v
}

func (o PermissionBucketControlsBody) MarshalJSON() ([]byte, error) {
...
func (o PermissionBucketControlsBody) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionBucketControlsBody struct {
	value *PermissionBucketControlsBody
	isSet bool
}

func (v NullablePermissionBucketControlsBody) Get() *PermissionBucketControlsBody {
	return v.value
}

func (v *NullablePermissionBucketControlsBody) Set(val *PermissionBucketControlsBody) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionBucketControlsBody) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionBucketControlsBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionBucketControlsBody(val *PermissionBucketControlsBody) *NullablePermissionBucketControlsBody {
	return &NullablePermissionBucketControlsBody{value: val, isSet: true}
}

func (v NullablePermissionBucketControlsBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionBucketControlsBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
