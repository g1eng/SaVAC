...
// checks if the AccountKeyData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountKeyData{}

// AccountKeyData data type
...
// NewAccountKeyData instantiates a new AccountKeyData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAccountKeyData() *AccountKeyData {
	this := AccountKeyData{}
	return &this
}

// NewAccountKeyDataWithDefaults instantiates a new AccountKeyData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAccountKeyDataWithDefaults() *AccountKeyData {
	this := AccountKeyData{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *AccountKeyData) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *AccountKeyData) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *AccountKeyData) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AccountKeyData) SetId(v string) {
	o.Id = &v
}

// GetSecret returns the Secret field value if set, zero value otherwise.
func (o *AccountKeyData) GetSecret() string {
...
// and a boolean to check if the value has been set.
func (o *AccountKeyData) GetSecretOk() (*string, bool) {
	if o == nil || IsNil(o.Secret) {
		return nil, false
	}
...
func (o *AccountKeyData) HasSecret() bool {
	if o != nil && !IsNil(o.Secret) {
		return true
	}
...
func (o *AccountKeyData) SetSecret(v string) {
	o.Secret = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *AccountKeyData) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AccountKeyData) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *AccountKeyData) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *AccountKeyData) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o AccountKeyData) MarshalJSON() ([]byte, error) {
...
func (o AccountKeyData) ToMap() (map[string]interface{}, error) {
...
type NullableAccountKeyData struct {
	value *AccountKeyData
	isSet bool
}

func (v NullableAccountKeyData) Get() *AccountKeyData {
	return v.value
}

func (v *NullableAccountKeyData) Set(val *AccountKeyData) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountKeyData) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountKeyData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountKeyData(val *AccountKeyData) *NullableAccountKeyData {
	return &NullableAccountKeyData{value: val, isSet: true}
}

func (v NullableAccountKeyData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountKeyData) UnmarshalJSON(src []byte) error {
	v.isSet = true
