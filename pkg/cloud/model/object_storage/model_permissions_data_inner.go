...
// checks if the PermissionsDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionsDataInner{}

// PermissionsDataInner struct for PermissionsDataInner
type PermissionsDataInner struct {
	// Permission ID
	Id *int64 `json:"id,omitempty"`
	// Display name
	DisplayName *string `json:"display_name,omitempty" validate:"regexp=^.+$"`
	// Bucket controls
	BucketControls []BucketControlsInner `json:"bucket_controls,omitempty"`
	// Created at
	CreatedAt *time.Time `json:"created_at,omitempty"`
}

// NewPermissionsDataInner instantiates a new PermissionsDataInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionsDataInner() *PermissionsDataInner {
	this := PermissionsDataInner{}
	return &this
}

// NewPermissionsDataInnerWithDefaults instantiates a new PermissionsDataInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionsDataInnerWithDefaults() *PermissionsDataInner {
	this := PermissionsDataInner{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *PermissionsDataInner) GetId() int64 {
	if o == nil || IsNil(o.Id) {
		var ret int64
		return ret
	}
...
func (o *PermissionsDataInner) GetIdOk() (*int64, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PermissionsDataInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PermissionsDataInner) SetId(v int64) {
	o.Id = &v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *PermissionsDataInner) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *PermissionsDataInner) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *PermissionsDataInner) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *PermissionsDataInner) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetBucketControls returns the BucketControls field value if set, zero value otherwise.
func (o *PermissionsDataInner) GetBucketControls() []BucketControlsInner {
	if o == nil || IsNil(o.BucketControls) {
		var ret []BucketControlsInner
		return ret
	}
	return o.BucketControls
}

// GetBucketControlsOk returns a tuple with the BucketControls field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PermissionsDataInner) GetBucketControlsOk() ([]BucketControlsInner, bool) {
	if o == nil || IsNil(o.BucketControls) {
		return nil, false
	}
	return o.BucketControls, true
}

// HasBucketControls returns a boolean if a field has been set.
func (o *PermissionsDataInner) HasBucketControls() bool {
	if o != nil && !IsNil(o.BucketControls) {
		return true
	}
...
// SetBucketControls gets a reference to the given []BucketControlsInner and assigns it to the BucketControls field.
func (o *PermissionsDataInner) SetBucketControls(v []BucketControlsInner) {
	o.BucketControls = v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *PermissionsDataInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PermissionsDataInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *PermissionsDataInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *PermissionsDataInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o PermissionsDataInner) MarshalJSON() ([]byte, error) {
...
func (o PermissionsDataInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BucketControls) {
		toSerialize["bucket_controls"] = o.BucketControls
	}
...
type NullablePermissionsDataInner struct {
	value *PermissionsDataInner
	isSet bool
}

func (v NullablePermissionsDataInner) Get() *PermissionsDataInner {
	return v.value
}

func (v *NullablePermissionsDataInner) Set(val *PermissionsDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionsDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionsDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionsDataInner(val *PermissionsDataInner) *NullablePermissionsDataInner {
	return &NullablePermissionsDataInner{value: val, isSet: true}
}

func (v NullablePermissionsDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionsDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
