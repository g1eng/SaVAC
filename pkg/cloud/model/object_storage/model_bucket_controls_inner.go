...
// checks if the BucketControlsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketControlsInner{}

// BucketControlsInner struct for BucketControlsInner
type BucketControlsInner struct {
	// Bucket name
	BucketName *string `json:"bucket_name,omitempty" validate:"regexp=^[a-zA-Z][a-zA-Z0-9]{2,}"`
...
// NewBucketControlsInner instantiates a new BucketControlsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBucketControlsInner() *BucketControlsInner {
	this := BucketControlsInner{}
	return &this
}

// NewBucketControlsInnerWithDefaults instantiates a new BucketControlsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBucketControlsInnerWithDefaults() *BucketControlsInner {
	this := BucketControlsInner{}
	return &this
}

// GetBucketName returns the BucketName field value if set, zero value otherwise.
func (o *BucketControlsInner) GetBucketName() string {
...
func (o *BucketControlsInner) GetBucketNameOk() (*string, bool) {
	if o == nil || IsNil(o.BucketName) {
		return nil, false
	}
...
func (o *BucketControlsInner) HasBucketName() bool {
	if o != nil && !IsNil(o.BucketName) {
		return true
	}
...
func (o *BucketControlsInner) SetBucketName(v string) {
	o.BucketName = &v
}

// GetCanRead returns the CanRead field value if set, zero value otherwise.
func (o *BucketControlsInner) GetCanRead() bool {
...
// and a boolean to check if the value has been set.
func (o *BucketControlsInner) GetCanReadOk() (*bool, bool) {
	if o == nil || IsNil(o.CanRead) {
		return nil, false
	}
...
func (o *BucketControlsInner) HasCanRead() bool {
	if o != nil && !IsNil(o.CanRead) {
		return true
	}
...
func (o *BucketControlsInner) SetCanRead(v bool) {
	o.CanRead = &v
}

// GetCanWrite returns the CanWrite field value if set, zero value otherwise.
func (o *BucketControlsInner) GetCanWrite() bool {
...
// and a boolean to check if the value has been set.
func (o *BucketControlsInner) GetCanWriteOk() (*bool, bool) {
	if o == nil || IsNil(o.CanWrite) {
		return nil, false
	}
...
func (o *BucketControlsInner) HasCanWrite() bool {
	if o != nil && !IsNil(o.CanWrite) {
		return true
	}
...
func (o *BucketControlsInner) SetCanWrite(v bool) {
	o.CanWrite = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *BucketControlsInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *BucketControlsInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *BucketControlsInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *BucketControlsInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o BucketControlsInner) MarshalJSON() ([]byte, error) {
...
func (o BucketControlsInner) ToMap() (map[string]interface{}, error) {
...
type NullableBucketControlsInner struct {
	value *BucketControlsInner
	isSet bool
}

func (v NullableBucketControlsInner) Get() *BucketControlsInner {
	return v.value
}

func (v *NullableBucketControlsInner) Set(val *BucketControlsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketControlsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketControlsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketControlsInner(val *BucketControlsInner) *NullableBucketControlsInner {
	return &NullableBucketControlsInner{value: val, isSet: true}
}

func (v NullableBucketControlsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketControlsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
