...
// checks if the ErrorDefault type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorDefault{}

// ErrorDefault struct for ErrorDefault
type ErrorDefault struct {
	Error *ErrorDefaultError `json:"error,omitempty"`
}

// NewErrorDefault instantiates a new ErrorDefault object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewErrorDefault() *ErrorDefault {
	this := ErrorDefault{}
	return &this
}

// NewErrorDefaultWithDefaults instantiates a new ErrorDefault object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewErrorDefaultWithDefaults() *ErrorDefault {
	this := ErrorDefault{}
	return &this
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *ErrorDefault) GetError() ErrorDefaultError {
	if o == nil || IsNil(o.Error) {
		var ret ErrorDefaultError
		return ret
	}
	return *o.Error
}
...
func (o *ErrorDefault) GetErrorOk() (*ErrorDefaultError, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *ErrorDefault) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
// SetError gets a reference to the given ErrorDefaultError and assigns it to the Error field.
func (o *ErrorDefault) SetError(v ErrorDefaultError) {
	o.Error = &v
}

func (o ErrorDefault) MarshalJSON() ([]byte, error) {
...
func (o ErrorDefault) ToMap() (map[string]interface{}, error) {
...
type NullableErrorDefault struct {
	value *ErrorDefault
	isSet bool
}

func (v NullableErrorDefault) Get() *ErrorDefault {
	return v.value
}

func (v *NullableErrorDefault) Set(val *ErrorDefault) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorDefault) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorDefault) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorDefault(val *ErrorDefault) *NullableErrorDefault {
	return &NullableErrorDefault{value: val, isSet: true}
}

func (v NullableErrorDefault) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorDefault) UnmarshalJSON(src []byte) error {
	v.isSet = true
