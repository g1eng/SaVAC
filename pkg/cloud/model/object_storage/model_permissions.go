...
type Permissions struct {
	// data type
	Data []PermissionsDataInner `json:"data,omitempty"`
}
...
func (o *Permissions) GetData() []PermissionsDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []PermissionsDataInner
		return ret
	}
	return o.Data
}
...
func (o *Permissions) GetDataOk() ([]PermissionsDataInner, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
// SetData gets a reference to the given []PermissionsDataInner and assigns it to the Data field.
func (o *Permissions) SetData(v []PermissionsDataInner) {
	o.Data = v
}
