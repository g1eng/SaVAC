...
// checks if the Error409Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error409Error{}

// Error409Error error 409
...
// NewError409Error instantiates a new Error409Error object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewError409Error() *Error409Error {
	this := Error409Error{}
	return &this
}

// NewError409ErrorWithDefaults instantiates a new Error409Error object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewError409ErrorWithDefaults() *Error409Error {
	this := Error409Error{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Error409Error) GetCode() int32 {
...
func (o *Error409Error) GetCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Error409Error) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *Error409Error) SetCode(v int32) {
	o.Code = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *Error409Error) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *Error409Error) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *Error409Error) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *Error409Error) SetMessage(v string) {
	o.Message = &v
}

// GetTraceId returns the TraceId field value if set, zero value otherwise.
func (o *Error409Error) GetTraceId() string {
...
// and a boolean to check if the value has been set.
func (o *Error409Error) GetTraceIdOk() (*string, bool) {
	if o == nil || IsNil(o.TraceId) {
		return nil, false
	}
...
func (o *Error409Error) HasTraceId() bool {
	if o != nil && !IsNil(o.TraceId) {
		return true
	}
...
func (o *Error409Error) SetTraceId(v string) {
	o.TraceId = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *Error409Error) GetErrors() []ErrorsInner {
...
// and a boolean to check if the value has been set.
func (o *Error409Error) GetErrorsOk() ([]ErrorsInner, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *Error409Error) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *Error409Error) SetErrors(v []ErrorsInner) {
	o.Errors = v
}

func (o Error409Error) MarshalJSON() ([]byte, error) {
...
func (o Error409Error) ToMap() (map[string]interface{}, error) {
...
type NullableError409Error struct {
	value *Error409Error
	isSet bool
}

func (v NullableError409Error) Get() *Error409Error {
	return v.value
}

func (v *NullableError409Error) Set(val *Error409Error) {
	v.value = val
	v.isSet = true
}

func (v NullableError409Error) IsSet() bool {
	return v.isSet
}

func (v *NullableError409Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableError409Error(val *Error409Error) *NullableError409Error {
	return &NullableError409Error{value: val, isSet: true}
}

func (v NullableError409Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableError409Error) UnmarshalJSON(src []byte) error {
	v.isSet = true
