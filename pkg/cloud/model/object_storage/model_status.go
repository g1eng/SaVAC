...
func (o *Status) GetData() StatusData {
...
func (o *Status) GetDataOk() (*StatusData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
// SetData gets a reference to the given StatusData and assigns it to the Data field.
func (o *Status) SetData(v StatusData) {
	o.Data = &v
}
