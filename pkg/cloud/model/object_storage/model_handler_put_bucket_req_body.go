...
// checks if the HandlerPutBucketReqBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerPutBucketReqBody{}

// HandlerPutBucketReqBody struct for HandlerPutBucketReqBody
type HandlerPutBucketReqBody struct {
	ClusterId string `json:"cluster_id"`
}

type _HandlerPutBucketReqBody HandlerPutBucketReqBody

// NewHandlerPutBucketReqBody instantiates a new HandlerPutBucketReqBody object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHandlerPutBucketReqBody(clusterId string) *HandlerPutBucketReqBody {
	this := HandlerPutBucketReqBody{}
	this.ClusterId = clusterId
	return &this
}

// NewHandlerPutBucketReqBodyWithDefaults instantiates a new HandlerPutBucketReqBody object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHandlerPutBucketReqBodyWithDefaults() *HandlerPutBucketReqBody {
	this := HandlerPutBucketReqBody{}
	return &this
}

// GetClusterId returns the ClusterId field value
func (o *HandlerPutBucketReqBody) GetClusterId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *HandlerPutBucketReqBody) GetClusterIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HandlerPutBucketReqBody) SetClusterId(v string) {
	o.ClusterId = v
}

func (o HandlerPutBucketReqBody) MarshalJSON() ([]byte, error) {
...
func (o HandlerPutBucketReqBody) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cluster_id"] = o.ClusterId
	return toSerialize, nil
}

func (o *HandlerPutBucketReqBody) UnmarshalJSON(data []byte) (err error) {
	...
	varHandlerPutBucketReqBody := _HandlerPutBucketReqBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHandlerPutBucketReqBody)

	if err != nil {
		return err
	}

	*o = HandlerPutBucketReqBody(varHandlerPutBucketReqBody)

	return err
}

type NullableHandlerPutBucketReqBody struct {
	value *HandlerPutBucketReqBody
	isSet bool
}

func (v NullableHandlerPutBucketReqBody) Get() *HandlerPutBucketReqBody {
	return v.value
}

func (v *NullableHandlerPutBucketReqBody) Set(val *HandlerPutBucketReqBody) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerPutBucketReqBody) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerPutBucketReqBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerPutBucketReqBody(val *HandlerPutBucketReqBody) *NullableHandlerPutBucketReqBody {
	return &NullableHandlerPutBucketReqBody{value: val, isSet: true}
}

func (v NullableHandlerPutBucketReqBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerPutBucketReqBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
