...
// checks if the HandlerListClustersRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerListClustersRes{}

// HandlerListClustersRes struct for HandlerListClustersRes
type HandlerListClustersRes struct {
	// If use a pointer type, braek output
	Data []ModelCluster `json:"data,omitempty"`
}

// NewHandlerListClustersRes instantiates a new HandlerListClustersRes object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHandlerListClustersRes() *HandlerListClustersRes {
	this := HandlerListClustersRes{}
	return &this
}

// NewHandlerListClustersResWithDefaults instantiates a new HandlerListClustersRes object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHandlerListClustersResWithDefaults() *HandlerListClustersRes {
	this := HandlerListClustersRes{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *HandlerListClustersRes) GetData() []ModelCluster {
	if o == nil || IsNil(o.Data) {
		var ret []ModelCluster
		return ret
	}
	return o.Data
}
...
func (o *HandlerListClustersRes) GetDataOk() ([]ModelCluster, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *HandlerListClustersRes) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []ModelCluster and assigns it to the Data field.
func (o *HandlerListClustersRes) SetData(v []ModelCluster) {
	o.Data = v
}

func (o HandlerListClustersRes) MarshalJSON() ([]byte, error) {
...
func (o HandlerListClustersRes) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerListClustersRes struct {
	value *HandlerListClustersRes
	isSet bool
}

func (v NullableHandlerListClustersRes) Get() *HandlerListClustersRes {
	return v.value
}

func (v *NullableHandlerListClustersRes) Set(val *HandlerListClustersRes) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerListClustersRes) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerListClustersRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerListClustersRes(val *HandlerListClustersRes) *NullableHandlerListClustersRes {
	return &NullableHandlerListClustersRes{value: val, isSet: true}
}

func (v NullableHandlerListClustersRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerListClustersRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
