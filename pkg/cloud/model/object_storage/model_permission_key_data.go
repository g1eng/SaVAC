...
// checks if the PermissionKeyData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionKeyData{}

// PermissionKeyData data type
...
// NewPermissionKeyData instantiates a new PermissionKeyData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionKeyData() *PermissionKeyData {
	this := PermissionKeyData{}
	return &this
}

// NewPermissionKeyDataWithDefaults instantiates a new PermissionKeyData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionKeyDataWithDefaults() *PermissionKeyData {
	this := PermissionKeyData{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *PermissionKeyData) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PermissionKeyData) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PermissionKeyData) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PermissionKeyData) SetId(v string) {
	o.Id = &v
}

// GetSecret returns the Secret field value if set, zero value otherwise.
func (o *PermissionKeyData) GetSecret() string {
...
// and a boolean to check if the value has been set.
func (o *PermissionKeyData) GetSecretOk() (*string, bool) {
	if o == nil || IsNil(o.Secret) {
		return nil, false
	}
...
func (o *PermissionKeyData) HasSecret() bool {
	if o != nil && !IsNil(o.Secret) {
		return true
	}
...
func (o *PermissionKeyData) SetSecret(v string) {
	o.Secret = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *PermissionKeyData) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PermissionKeyData) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *PermissionKeyData) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *PermissionKeyData) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o PermissionKeyData) MarshalJSON() ([]byte, error) {
...
func (o PermissionKeyData) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionKeyData struct {
	value *PermissionKeyData
	isSet bool
}

func (v NullablePermissionKeyData) Get() *PermissionKeyData {
	return v.value
}

func (v *NullablePermissionKeyData) Set(val *PermissionKeyData) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionKeyData) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionKeyData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionKeyData(val *PermissionKeyData) *NullablePermissionKeyData {
	return &NullablePermissionKeyData{value: val, isSet: true}
}

func (v NullablePermissionKeyData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionKeyData) UnmarshalJSON(src []byte) error {
	v.isSet = true
