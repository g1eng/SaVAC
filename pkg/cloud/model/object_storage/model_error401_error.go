...
// checks if the Error401Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error401Error{}

// Error401Error error 401
...
// NewError401Error instantiates a new Error401Error object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewError401Error() *Error401Error {
	this := Error401Error{}
	return &this
}

// NewError401ErrorWithDefaults instantiates a new Error401Error object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewError401ErrorWithDefaults() *Error401Error {
	this := Error401Error{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Error401Error) GetCode() int32 {
...
func (o *Error401Error) GetCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Error401Error) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *Error401Error) SetCode(v int32) {
	o.Code = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *Error401Error) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *Error401Error) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *Error401Error) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *Error401Error) SetMessage(v string) {
	o.Message = &v
}

// GetTraceId returns the TraceId field value if set, zero value otherwise.
func (o *Error401Error) GetTraceId() string {
...
// and a boolean to check if the value has been set.
func (o *Error401Error) GetTraceIdOk() (*string, bool) {
	if o == nil || IsNil(o.TraceId) {
		return nil, false
	}
...
func (o *Error401Error) HasTraceId() bool {
	if o != nil && !IsNil(o.TraceId) {
		return true
	}
...
func (o *Error401Error) SetTraceId(v string) {
	o.TraceId = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *Error401Error) GetErrors() []ErrorsInner {
...
// and a boolean to check if the value has been set.
func (o *Error401Error) GetErrorsOk() ([]ErrorsInner, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *Error401Error) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *Error401Error) SetErrors(v []ErrorsInner) {
	o.Errors = v
}

func (o Error401Error) MarshalJSON() ([]byte, error) {
...
func (o Error401Error) ToMap() (map[string]interface{}, error) {
...
type NullableError401Error struct {
	value *Error401Error
	isSet bool
}

func (v NullableError401Error) Get() *Error401Error {
	return v.value
}

func (v *NullableError401Error) Set(val *Error401Error) {
	v.value = val
	v.isSet = true
}

func (v NullableError401Error) IsSet() bool {
	return v.isSet
}

func (v *NullableError401Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableError401Error(val *Error401Error) *NullableError401Error {
	return &NullableError401Error{value: val, isSet: true}
}

func (v NullableError401Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableError401Error) UnmarshalJSON(src []byte) error {
	v.isSet = true
