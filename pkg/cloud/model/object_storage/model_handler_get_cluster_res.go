...
// checks if the HandlerGetClusterRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerGetClusterRes{}

// HandlerGetClusterRes struct for HandlerGetClusterRes
type HandlerGetClusterRes struct {
	Data *ModelCluster `json:"data,omitempty"`
}

// NewHandlerGetClusterRes instantiates a new HandlerGetClusterRes object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHandlerGetClusterRes() *HandlerGetClusterRes {
	this := HandlerGetClusterRes{}
	return &this
}

// NewHandlerGetClusterResWithDefaults instantiates a new HandlerGetClusterRes object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHandlerGetClusterResWithDefaults() *HandlerGetClusterRes {
	this := HandlerGetClusterRes{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *HandlerGetClusterRes) GetData() ModelCluster {
...
func (o *HandlerGetClusterRes) GetDataOk() (*ModelCluster, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *HandlerGetClusterRes) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *HandlerGetClusterRes) SetData(v ModelCluster) {
	o.Data = &v
}

func (o HandlerGetClusterRes) MarshalJSON() ([]byte, error) {
...
func (o HandlerGetClusterRes) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerGetClusterRes struct {
	value *HandlerGetClusterRes
	isSet bool
}

func (v NullableHandlerGetClusterRes) Get() *HandlerGetClusterRes {
	return v.value
}

func (v *NullableHandlerGetClusterRes) Set(val *HandlerGetClusterRes) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerGetClusterRes) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerGetClusterRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerGetClusterRes(val *HandlerGetClusterRes) *NullableHandlerGetClusterRes {
	return &NullableHandlerGetClusterRes{value: val, isSet: true}
}

func (v NullableHandlerGetClusterRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerGetClusterRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
