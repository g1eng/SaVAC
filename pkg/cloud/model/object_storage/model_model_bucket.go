...
// checks if the ModelBucket type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelBucket{}

// ModelBucket struct for ModelBucket
type ModelBucket struct {
	ClusterId *string `json:"cluster_id,omitempty"`
	Name      *string `json:"name,omitempty"`
}

// NewModelBucket instantiates a new ModelBucket object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewModelBucket() *ModelBucket {
	this := ModelBucket{}
	return &this
}

// NewModelBucketWithDefaults instantiates a new ModelBucket object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewModelBucketWithDefaults() *ModelBucket {
	this := ModelBucket{}
	return &this
}

// GetClusterId returns the ClusterId field value if set, zero value otherwise.
func (o *ModelBucket) GetClusterId() string {
...
func (o *ModelBucket) GetClusterIdOk() (*string, bool) {
	if o == nil || IsNil(o.ClusterId) {
		return nil, false
	}
...
func (o *ModelBucket) HasClusterId() bool {
	if o != nil && !IsNil(o.ClusterId) {
		return true
	}
...
func (o *ModelBucket) SetClusterId(v string) {
	o.ClusterId = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *ModelBucket) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *ModelBucket) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ModelBucket) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ModelBucket) SetName(v string) {
	o.Name = &v
}

func (o ModelBucket) MarshalJSON() ([]byte, error) {
...
func (o ModelBucket) ToMap() (map[string]interface{}, error) {
...
type NullableModelBucket struct {
	value *ModelBucket
	isSet bool
}

func (v NullableModelBucket) Get() *ModelBucket {
	return v.value
}

func (v *NullableModelBucket) Set(val *ModelBucket) {
	v.value = val
	v.isSet = true
}

func (v NullableModelBucket) IsSet() bool {
	return v.isSet
}

func (v *NullableModelBucket) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelBucket(val *ModelBucket) *NullableModelBucket {
	return &NullableModelBucket{value: val, isSet: true}
}

func (v NullableModelBucket) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelBucket) UnmarshalJSON(src []byte) error {
	v.isSet = true
