...
// checks if the AccountKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountKey{}

// AccountKey Root user access key
type AccountKey struct {
	Data *AccountKeyData `json:"data,omitempty"`
}
...
func (o *AccountKey) GetData() AccountKeyData {
	if o == nil || IsNil(o.Data) {
		var ret AccountKeyData
		return ret
	}
	return *o.Data
}
...
func (o *AccountKey) GetDataOk() (*AccountKeyData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *AccountKey) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given AccountKeyData and assigns it to the Data field.
func (o *AccountKey) SetData(v AccountKeyData) {
	o.Data = &v
}
...
func (o AccountKey) ToMap() (map[string]interface{}, error) {
