...
// checks if the HandlerPutBucketRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerPutBucketRes{}

// HandlerPutBucketRes struct for HandlerPutBucketRes
type HandlerPutBucketRes struct {
	Data *ModelBucket `json:"data,omitempty"`
}

// NewHandlerPutBucketRes instantiates a new HandlerPutBucketRes object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHandlerPutBucketRes() *HandlerPutBucketRes {
	this := HandlerPutBucketRes{}
	return &this
}

// NewHandlerPutBucketResWithDefaults instantiates a new HandlerPutBucketRes object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHandlerPutBucketResWithDefaults() *HandlerPutBucketRes {
	this := HandlerPutBucketRes{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *HandlerPutBucketRes) GetData() ModelBucket {
...
func (o *HandlerPutBucketRes) GetDataOk() (*ModelBucket, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *HandlerPutBucketRes) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given ModelBucket and assigns it to the Data field.
func (o *HandlerPutBucketRes) SetData(v ModelBucket) {
	o.Data = &v
}

func (o HandlerPutBucketRes) MarshalJSON() ([]byte, error) {
...
func (o HandlerPutBucketRes) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerPutBucketRes struct {
	value *HandlerPutBucketRes
	isSet bool
}

func (v NullableHandlerPutBucketRes) Get() *HandlerPutBucketRes {
	return v.value
}

func (v *NullableHandlerPutBucketRes) Set(val *HandlerPutBucketRes) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerPutBucketRes) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerPutBucketRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerPutBucketRes(val *HandlerPutBucketRes) *NullableHandlerPutBucketRes {
	return &NullableHandlerPutBucketRes{value: val, isSet: true}
}

func (v NullableHandlerPutBucketRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerPutBucketRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
