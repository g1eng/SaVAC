...
// checks if the AccountKeysDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountKeysDataInner{}

// AccountKeysDataInner struct for AccountKeysDataInner
type AccountKeysDataInner struct {
	// Access key ID
	Id *string `json:"id,omitempty" validate:"regexp=^[\\\\w\\\\d\\/]{1,40}$"`
	// Secret Access key
...
// NewAccountKeysDataInner instantiates a new AccountKeysDataInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAccountKeysDataInner() *AccountKeysDataInner {
	this := AccountKeysDataInner{}
	return &this
}

// NewAccountKeysDataInnerWithDefaults instantiates a new AccountKeysDataInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAccountKeysDataInnerWithDefaults() *AccountKeysDataInner {
	this := AccountKeysDataInner{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *AccountKeysDataInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *AccountKeysDataInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *AccountKeysDataInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AccountKeysDataInner) SetId(v string) {
	o.Id = &v
}

// GetSecret returns the Secret field value if set, zero value otherwise.
func (o *AccountKeysDataInner) GetSecret() string {
...
// and a boolean to check if the value has been set.
func (o *AccountKeysDataInner) GetSecretOk() (*string, bool) {
	if o == nil || IsNil(o.Secret) {
		return nil, false
	}
...
func (o *AccountKeysDataInner) HasSecret() bool {
	if o != nil && !IsNil(o.Secret) {
		return true
	}
...
func (o *AccountKeysDataInner) SetSecret(v string) {
	o.Secret = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *AccountKeysDataInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AccountKeysDataInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *AccountKeysDataInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *AccountKeysDataInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o AccountKeysDataInner) MarshalJSON() ([]byte, error) {
...
func (o AccountKeysDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableAccountKeysDataInner struct {
	value *AccountKeysDataInner
	isSet bool
}

func (v NullableAccountKeysDataInner) Get() *AccountKeysDataInner {
	return v.value
}

func (v *NullableAccountKeysDataInner) Set(val *AccountKeysDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountKeysDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountKeysDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountKeysDataInner(val *AccountKeysDataInner) *NullableAccountKeysDataInner {
	return &NullableAccountKeysDataInner{value: val, isSet: true}
}

func (v NullableAccountKeysDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountKeysDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
