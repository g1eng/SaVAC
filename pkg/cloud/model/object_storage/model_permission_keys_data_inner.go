...
// checks if the PermissionKeysDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionKeysDataInner{}

// PermissionKeysDataInner struct for PermissionKeysDataInner
type PermissionKeysDataInner struct {
	// Permission Key ID
	Id *string `json:"id,omitempty"`
	// Permission secret key
	Secret *string `json:"secret,omitempty" validate:"regexp=^[\\\\w\\\\d\\/+=]{1,40}$"`
	// Created at
	CreatedAt *time.Time `json:"created_at,omitempty"`
}

// NewPermissionKeysDataInner instantiates a new PermissionKeysDataInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionKeysDataInner() *PermissionKeysDataInner {
	this := PermissionKeysDataInner{}
	return &this
}

// NewPermissionKeysDataInnerWithDefaults instantiates a new PermissionKeysDataInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionKeysDataInnerWithDefaults() *PermissionKeysDataInner {
	this := PermissionKeysDataInner{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *PermissionKeysDataInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PermissionKeysDataInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PermissionKeysDataInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PermissionKeysDataInner) SetId(v string) {
	o.Id = &v
}

// GetSecret returns the Secret field value if set, zero value otherwise.
func (o *PermissionKeysDataInner) GetSecret() string {
...
// and a boolean to check if the value has been set.
func (o *PermissionKeysDataInner) GetSecretOk() (*string, bool) {
	if o == nil || IsNil(o.Secret) {
		return nil, false
	}
...
func (o *PermissionKeysDataInner) HasSecret() bool {
	if o != nil && !IsNil(o.Secret) {
		return true
	}
...
func (o *PermissionKeysDataInner) SetSecret(v string) {
	o.Secret = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *PermissionKeysDataInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PermissionKeysDataInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *PermissionKeysDataInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *PermissionKeysDataInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o PermissionKeysDataInner) MarshalJSON() ([]byte, error) {
...
func (o PermissionKeysDataInner) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionKeysDataInner struct {
	value *PermissionKeysDataInner
	isSet bool
}

func (v NullablePermissionKeysDataInner) Get() *PermissionKeysDataInner {
	return v.value
}

func (v *NullablePermissionKeysDataInner) Set(val *PermissionKeysDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionKeysDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionKeysDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionKeysDataInner(val *PermissionKeysDataInner) *NullablePermissionKeysDataInner {
	return &NullablePermissionKeysDataInner{value: val, isSet: true}
}

func (v NullablePermissionKeysDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionKeysDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
