...
type Error401 struct {
	Error *Error401Error `json:"error,omitempty"`
}
...
func (o *Error401) GetError() Error401Error {
	if o == nil || IsNil(o.Error) {
		var ret Error401Error
		return ret
	}
	return *o.Error
}
...
func (o *Error401) GetErrorOk() (*Error401Error, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given Error401Error and assigns it to the Error field.
func (o *Error401) SetError(v Error401Error) {
	o.Error = &v
}
