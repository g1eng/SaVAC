...
// AccountData data type
type AccountData struct {
	// Resource ID
	ResourceId *string `json:"resource_id,omitempty" validate:"regexp=\\\\d{1,12}"`
	// Code
	Code *string `json:"code,omitempty" validate:"regexp=^[\\\\w@]+$"`
	// Created at
...
func (o *AccountData) GetResourceId() string {
...
func (o *AccountData) GetResourceIdOk() (*string, bool) {
	if o == nil || IsNil(o.ResourceId) {
		return nil, false
	}
...
func (o *AccountData) HasResourceId() bool {
	if o != nil && !IsNil(o.ResourceId) {
		return true
	}
...
func (o *AccountData) SetResourceId(v string) {
	o.ResourceId = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *AccountData) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *AccountData) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *AccountData) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *AccountData) SetCode(v string) {
	o.Code = &v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *AccountData) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AccountData) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *AccountData) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *AccountData) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}
