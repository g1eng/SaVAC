...
type Error403 struct {
	Error *Error403Error `json:"error,omitempty"`
}
...
func (o *Error403) GetError() Error403Error {
	if o == nil || IsNil(o.Error) {
		var ret Error403Error
		return ret
	}
	return *o.Error
}
...
func (o *Error403) GetErrorOk() (*Error403Error, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given Error403Error and assigns it to the Error field.
func (o *Error403) SetError(v Error403Error) {
	o.Error = &v
}
