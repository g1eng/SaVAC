...
// checks if the PermissionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionData{}

// PermissionData data type
...
func (o *PermissionData) GetId() int64 {
	if o == nil || IsNil(o.Id) {
		var ret int64
		return ret
	}
...
func (o *PermissionData) GetIdOk() (*int64, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PermissionData) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PermissionData) SetId(v int64) {
	o.Id = &v
}
...
// and a boolean to check if the value has been set.
func (o *PermissionData) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *PermissionData) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *PermissionData) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetBucketControls returns the BucketControls field value if set, zero value otherwise.
func (o *PermissionData) GetBucketControls() []BucketControlsInner {
...
// and a boolean to check if the value has been set.
func (o *PermissionData) GetBucketControlsOk() ([]BucketControlsInner, bool) {
	if o == nil || IsNil(o.BucketControls) {
		return nil, false
	}
...
func (o *PermissionData) HasBucketControls() bool {
	if o != nil && !IsNil(o.BucketControls) {
		return true
	}
...
func (o *PermissionData) SetBucketControls(v []BucketControlsInner) {
	o.BucketControls = v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *PermissionData) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *PermissionData) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *PermissionData) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *PermissionData) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

func (o PermissionData) MarshalJSON() ([]byte, error) {
...
func (o PermissionData) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionData struct {
	value *PermissionData
	isSet bool
}

func (v NullablePermissionData) Get() *PermissionData {
	return v.value
}

func (v *NullablePermissionData) Set(val *PermissionData) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionData) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionData(val *PermissionData) *NullablePermissionData {
	return &NullablePermissionData{value: val, isSet: true}
}

func (v NullablePermissionData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionData) UnmarshalJSON(src []byte) error {
	v.isSet = true
