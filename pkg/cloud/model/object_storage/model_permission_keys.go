...
// checks if the PermissionKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionKeys{}

// PermissionKeys Permission Key
type PermissionKeys struct {
	// data type
	Data []PermissionKeysDataInner `json:"data,omitempty"`
}

// NewPermissionKeys instantiates a new PermissionKeys object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionKeys() *PermissionKeys {
	this := PermissionKeys{}
	return &this
}

// NewPermissionKeysWithDefaults instantiates a new PermissionKeys object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionKeysWithDefaults() *PermissionKeys {
	this := PermissionKeys{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PermissionKeys) GetData() []PermissionKeysDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []PermissionKeysDataInner
		return ret
	}
	return o.Data
}
...
func (o *PermissionKeys) GetDataOk() ([]PermissionKeysDataInner, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *PermissionKeys) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []PermissionKeysDataInner and assigns it to the Data field.
func (o *PermissionKeys) SetData(v []PermissionKeysDataInner) {
	o.Data = v
}

func (o PermissionKeys) MarshalJSON() ([]byte, error) {
...
func (o PermissionKeys) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionKeys struct {
	value *PermissionKeys
	isSet bool
}

func (v NullablePermissionKeys) Get() *PermissionKeys {
	return v.value
}

func (v *NullablePermissionKeys) Set(val *PermissionKeys) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionKeys) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionKeys(val *PermissionKeys) *NullablePermissionKeys {
	return &NullablePermissionKeys{value: val, isSet: true}
}

func (v NullablePermissionKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
