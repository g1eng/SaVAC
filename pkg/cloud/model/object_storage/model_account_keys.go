...
// checks if the AccountKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountKeys{}

// AccountKeys Root user access keys
type AccountKeys struct {
	// data type
	Data []AccountKeysDataInner `json:"data,omitempty"`
}

// NewAccountKeys instantiates a new AccountKeys object
...
// NewAccountKeysWithDefaults instantiates a new AccountKeys object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAccountKeysWithDefaults() *AccountKeys {
	this := AccountKeys{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *AccountKeys) GetData() []AccountKeysDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []AccountKeysDataInner
		return ret
	}
	return o.Data
}
...
func (o *AccountKeys) GetDataOk() ([]AccountKeysDataInner, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *AccountKeys) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []AccountKeysDataInner and assigns it to the Data field.
func (o *AccountKeys) SetData(v []AccountKeysDataInner) {
	o.Data = v
}

func (o AccountKeys) MarshalJSON() ([]byte, error) {
...
func (o AccountKeys) ToMap() (map[string]interface{}, error) {
...
type NullableAccountKeys struct {
	value *AccountKeys
	isSet bool
}

func (v NullableAccountKeys) Get() *AccountKeys {
	return v.value
}

func (v *NullableAccountKeys) Set(val *AccountKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountKeys(val *AccountKeys) *NullableAccountKeys {
	return &NullableAccountKeys{value: val, isSet: true}
}

func (v NullableAccountKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
