...
var _ MappedNullable = &Error400{}

// Error400 struct for Error400
type Error400 struct {
	Error *Error400Error `json:"error,omitempty"`
}
...
func (o *Error400) GetError() Error400Error {
	if o == nil || IsNil(o.Error) {
		var ret Error400Error
		return ret
	}
	return *o.Error
}
...
func (o *Error400) GetErrorOk() (*Error400Error, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given Error400Error and assigns it to the Error field.
func (o *Error400) SetError(v Error400Error) {
	o.Error = &v
}
