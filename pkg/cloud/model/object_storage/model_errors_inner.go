...
func (o *ErrorsInner) GetDomain() string {
...
func (o *ErrorsInner) GetDomainOk() (*string, bool) {
	if o == nil || IsNil(o.Domain) {
		return nil, false
	}
...
func (o *ErrorsInner) HasDomain() bool {
	if o != nil && !IsNil(o.Domain) {
		return true
	}
...
func (o *ErrorsInner) SetDomain(v string) {
	o.Domain = &v
}

// GetLocation returns the Location field value if set, zero value otherwise.
func (o *ErrorsInner) GetLocation() string {
...
// and a boolean to check if the value has been set.
func (o *ErrorsInner) GetLocationOk() (*string, bool) {
	if o == nil || IsNil(o.Location) {
		return nil, false
	}
...
func (o *ErrorsInner) HasLocation() bool {
	if o != nil && !IsNil(o.Location) {
		return true
	}
...
func (o *ErrorsInner) SetLocation(v string) {
	o.Location = &v
}

// GetLocationType returns the LocationType field value if set, zero value otherwise.
func (o *ErrorsInner) GetLocationType() string {
...
// and a boolean to check if the value has been set.
func (o *ErrorsInner) GetLocationTypeOk() (*string, bool) {
	if o == nil || IsNil(o.LocationType) {
		return nil, false
	}
...
func (o *ErrorsInner) HasLocationType() bool {
	if o != nil && !IsNil(o.LocationType) {
		return true
	}
...
func (o *ErrorsInner) SetLocationType(v string) {
	o.LocationType = &v
}
...
func (o *ErrorsInner) HasReason() bool {
	if o != nil && !IsNil(o.Reason) {
		return true
	}
