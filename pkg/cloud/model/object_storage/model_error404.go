...
type Error404 struct {
	Error *Error404Error `json:"error,omitempty"`
}
...
func (o *Error404) GetError() Error404Error {
	if o == nil || IsNil(o.Error) {
		var ret Error404Error
		return ret
	}
	return *o.Error
}
...
func (o *Error404) GetErrorOk() (*Error404Error, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given Error404Error and assigns it to the Error field.
func (o *Error404) SetError(v Error404Error) {
	o.Error = &v
}
