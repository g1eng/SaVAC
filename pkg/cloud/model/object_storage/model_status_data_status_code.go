...
// checks if the StatusDataStatusCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatusDataStatusCode{}

// StatusDataStatusCode struct for StatusDataStatusCode
type StatusDataStatusCode struct {
	Id     *int32  `json:"id,omitempty"`
	Status *string `json:"status,omitempty"`
}

// NewStatusDataStatusCode instantiates a new StatusDataStatusCode object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewStatusDataStatusCode() *StatusDataStatusCode {
	this := StatusDataStatusCode{}
	return &this
}

// NewStatusDataStatusCodeWithDefaults instantiates a new StatusDataStatusCode object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewStatusDataStatusCodeWithDefaults() *StatusDataStatusCode {
	this := StatusDataStatusCode{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *StatusDataStatusCode) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *StatusDataStatusCode) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *StatusDataStatusCode) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *StatusDataStatusCode) SetId(v int32) {
	o.Id = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *StatusDataStatusCode) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *StatusDataStatusCode) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *StatusDataStatusCode) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *StatusDataStatusCode) SetStatus(v string) {
	o.Status = &v
}

func (o StatusDataStatusCode) MarshalJSON() ([]byte, error) {
...
func (o StatusDataStatusCode) ToMap() (map[string]interface{}, error) {
...
type NullableStatusDataStatusCode struct {
	value *StatusDataStatusCode
	isSet bool
}

func (v NullableStatusDataStatusCode) Get() *StatusDataStatusCode {
	return v.value
}

func (v *NullableStatusDataStatusCode) Set(val *StatusDataStatusCode) {
	v.value = val
	v.isSet = true
}

func (v NullableStatusDataStatusCode) IsSet() bool {
	return v.isSet
}

func (v *NullableStatusDataStatusCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatusDataStatusCode(val *StatusDataStatusCode) *NullableStatusDataStatusCode {
	return &NullableStatusDataStatusCode{value: val, isSet: true}
}

func (v NullableStatusDataStatusCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatusDataStatusCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
