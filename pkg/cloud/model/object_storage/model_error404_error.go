...
// checks if the Error404Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error404Error{}

// Error404Error error 404
...
// NewError404Error instantiates a new Error404Error object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewError404Error() *Error404Error {
	this := Error404Error{}
	return &this
}

// NewError404ErrorWithDefaults instantiates a new Error404Error object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewError404ErrorWithDefaults() *Error404Error {
	this := Error404Error{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Error404Error) GetCode() int32 {
...
func (o *Error404Error) GetCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Error404Error) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *Error404Error) SetCode(v int32) {
	o.Code = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *Error404Error) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *Error404Error) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *Error404Error) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *Error404Error) SetMessage(v string) {
	o.Message = &v
}

// GetTraceId returns the TraceId field value if set, zero value otherwise.
func (o *Error404Error) GetTraceId() string {
...
// and a boolean to check if the value has been set.
func (o *Error404Error) GetTraceIdOk() (*string, bool) {
	if o == nil || IsNil(o.TraceId) {
		return nil, false
	}
...
func (o *Error404Error) HasTraceId() bool {
	if o != nil && !IsNil(o.TraceId) {
		return true
	}
...
func (o *Error404Error) SetTraceId(v string) {
	o.TraceId = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *Error404Error) GetErrors() []ErrorsInner {
...
// and a boolean to check if the value has been set.
func (o *Error404Error) GetErrorsOk() ([]ErrorsInner, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *Error404Error) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *Error404Error) SetErrors(v []ErrorsInner) {
	o.Errors = v
}

func (o Error404Error) MarshalJSON() ([]byte, error) {
...
func (o Error404Error) ToMap() (map[string]interface{}, error) {
...
type NullableError404Error struct {
	value *Error404Error
	isSet bool
}

func (v NullableError404Error) Get() *Error404Error {
	return v.value
}

func (v *NullableError404Error) Set(val *Error404Error) {
	v.value = val
	v.isSet = true
}

func (v NullableError404Error) IsSet() bool {
	return v.isSet
}

func (v *NullableError404Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableError404Error(val *Error404Error) *NullableError404Error {
	return &NullableError404Error{value: val, isSet: true}
}

func (v NullableError404Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableError404Error) UnmarshalJSON(src []byte) error {
	v.isSet = true
