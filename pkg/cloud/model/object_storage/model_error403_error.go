...
// checks if the Error403Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Error403Error{}

// Error403Error error 403
...
// NewError403Error instantiates a new Error403Error object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewError403Error() *Error403Error {
	this := Error403Error{}
	return &this
}

// NewError403ErrorWithDefaults instantiates a new Error403Error object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewError403ErrorWithDefaults() *Error403Error {
	this := Error403Error{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Error403Error) GetCode() int32 {
...
func (o *Error403Error) GetCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Error403Error) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *Error403Error) SetCode(v int32) {
	o.Code = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *Error403Error) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *Error403Error) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *Error403Error) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *Error403Error) SetMessage(v string) {
	o.Message = &v
}

// GetTraceId returns the TraceId field value if set, zero value otherwise.
func (o *Error403Error) GetTraceId() string {
...
// and a boolean to check if the value has been set.
func (o *Error403Error) GetTraceIdOk() (*string, bool) {
	if o == nil || IsNil(o.TraceId) {
		return nil, false
	}
...
func (o *Error403Error) HasTraceId() bool {
	if o != nil && !IsNil(o.TraceId) {
		return true
	}
...
func (o *Error403Error) SetTraceId(v string) {
	o.TraceId = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *Error403Error) GetErrors() []ErrorsInner {
...
// and a boolean to check if the value has been set.
func (o *Error403Error) GetErrorsOk() ([]ErrorsInner, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *Error403Error) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *Error403Error) SetErrors(v []ErrorsInner) {
	o.Errors = v
}

func (o Error403Error) MarshalJSON() ([]byte, error) {
...
func (o Error403Error) ToMap() (map[string]interface{}, error) {
...
type NullableError403Error struct {
	value *Error403Error
	isSet bool
}

func (v NullableError403Error) Get() *Error403Error {
	return v.value
}

func (v *NullableError403Error) Set(val *Error403Error) {
	v.value = val
	v.isSet = true
}

func (v NullableError403Error) IsSet() bool {
	return v.isSet
}

func (v *NullableError403Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableError403Error(val *Error403Error) *NullableError403Error {
	return &NullableError403Error{value: val, isSet: true}
}

func (v NullableError403Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableError403Error) UnmarshalJSON(src []byte) error {
	v.isSet = true
