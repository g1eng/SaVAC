...
// checks if the PermissionKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionKey{}

// PermissionKey Permission Key
type PermissionKey struct {
	Data *PermissionKeyData `json:"data,omitempty"`
}

// NewPermissionKey instantiates a new PermissionKey object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPermissionKey() *PermissionKey {
	this := PermissionKey{}
	return &this
}

// NewPermissionKeyWithDefaults instantiates a new PermissionKey object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPermissionKeyWithDefaults() *PermissionKey {
	this := PermissionKey{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PermissionKey) GetData() PermissionKeyData {
	if o == nil || IsNil(o.Data) {
		var ret PermissionKeyData
		return ret
	}
	return *o.Data
}
...
func (o *PermissionKey) GetDataOk() (*PermissionKeyData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *PermissionKey) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given PermissionKeyData and assigns it to the Data field.
func (o *PermissionKey) SetData(v PermissionKeyData) {
	o.Data = &v
}

func (o PermissionKey) MarshalJSON() ([]byte, error) {
...
func (o PermissionKey) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionKey struct {
	value *PermissionKey
	isSet bool
}

func (v NullablePermissionKey) Get() *PermissionKey {
	return v.value
}

func (v *NullablePermissionKey) Set(val *PermissionKey) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionKey) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionKey(val *PermissionKey) *NullablePermissionKey {
	return &NullablePermissionKey{value: val, isSet: true}
}

func (v NullablePermissionKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
