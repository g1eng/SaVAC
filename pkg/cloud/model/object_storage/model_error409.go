...
type Error409 struct {
	Error *Error409Error `json:"error,omitempty"`
}
...
func (o *Error409) GetError() Error409Error {
	if o == nil || IsNil(o.Error) {
		var ret Error409Error
		return ret
	}
	return *o.Error
}
...
func (o *Error409) GetErrorOk() (*Error409Error, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// SetError gets a reference to the given Error409Error and assigns it to the Error field.
func (o *Error409) SetError(v Error409Error) {
	o.Error = &v
}
