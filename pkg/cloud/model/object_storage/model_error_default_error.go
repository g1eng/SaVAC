...
// checks if the ErrorDefaultError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorDefaultError{}

// ErrorDefaultError error 500
...
// NewErrorDefaultError instantiates a new ErrorDefaultError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewErrorDefaultError() *ErrorDefaultError {
	this := ErrorDefaultError{}
	return &this
}

// NewErrorDefaultErrorWithDefaults instantiates a new ErrorDefaultError object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewErrorDefaultErrorWithDefaults() *ErrorDefaultError {
	this := ErrorDefaultError{}
	return &this
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *ErrorDefaultError) GetCode() int32 {
...
func (o *ErrorDefaultError) GetCodeOk() (*int32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *ErrorDefaultError) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ErrorDefaultError) SetCode(v int32) {
	o.Code = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *ErrorDefaultError) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *ErrorDefaultError) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *ErrorDefaultError) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *ErrorDefaultError) SetMessage(v string) {
	o.Message = &v
}

// GetTraceId returns the TraceId field value if set, zero value otherwise.
func (o *ErrorDefaultError) GetTraceId() string {
...
// and a boolean to check if the value has been set.
func (o *ErrorDefaultError) GetTraceIdOk() (*string, bool) {
	if o == nil || IsNil(o.TraceId) {
		return nil, false
	}
...
func (o *ErrorDefaultError) HasTraceId() bool {
	if o != nil && !IsNil(o.TraceId) {
		return true
	}
...
func (o *ErrorDefaultError) SetTraceId(v string) {
	o.TraceId = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *ErrorDefaultError) GetErrors() []ErrorsInner {
...
// and a boolean to check if the value has been set.
func (o *ErrorDefaultError) GetErrorsOk() ([]ErrorsInner, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *ErrorDefaultError) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *ErrorDefaultError) SetErrors(v []ErrorsInner) {
	o.Errors = v
}

func (o ErrorDefaultError) MarshalJSON() ([]byte, error) {
...
func (o ErrorDefaultError) ToMap() (map[string]interface{}, error) {
...
type NullableErrorDefaultError struct {
	value *ErrorDefaultError
	isSet bool
}

func (v NullableErrorDefaultError) Get() *ErrorDefaultError {
	return v.value
}

func (v *NullableErrorDefaultError) Set(val *ErrorDefaultError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorDefaultError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorDefaultError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorDefaultError(val *ErrorDefaultError) *NullableErrorDefaultError {
	return &NullableErrorDefaultError{value: val, isSet: true}
}

func (v NullableErrorDefaultError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorDefaultError) UnmarshalJSON(src []byte) error {
	v.isSet = true
